...
import com.food.service.ReviewSerive;
...
public class ReviewController {
	...
	@PostMapping("/review")
	public ResponseEntity<Review> createReview(@RequestBody ReviewRequest review,@RequestHeader("Authorization") String jwt) throws Exception{
